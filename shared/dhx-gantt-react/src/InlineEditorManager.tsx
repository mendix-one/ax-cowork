...
const PortalBridge: React.FC<PortalBridgeProps> = function InlineEditorBridge({
  editor,
  EditorComponent,
  onUnmount,
}) {
...
export const InlineEditorsManager: React.FC<InlineEditorsManagerProps> = React.memo(
  ({ activeEditors, inlineEditors, closeEditor, ganttInstance }) => {
    return (
      <>
