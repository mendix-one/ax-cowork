...
export function createDataProcessor(config: any) {
  ...
  if (config instanceof Function) {
    router = config
  } else if (Object.prototype.hasOwnProperty.call(config, 'router')) {
    router = config.router
  } else if (
    Object.prototype.hasOwnProperty.call(config, 'assignment') ||
    Object.prototype.hasOwnProperty.call(config, 'baseline') ||
    Object.prototype.hasOwnProperty.call(config, 'link') ||
    Object.prototype.hasOwnProperty.call(config, 'task')
  ) {
    router = config
  } else if (Object.prototype.hasOwnProperty.call(config, 'headers')) {
...
export class DataProcessor {
  ...
  serialize_one(data: any, pref: string) {
    ...
    for (const key in data)
      if (Object.prototype.hasOwnProperty.call(data, key)) {
        if (
          (key === 'id' || key == this.action_param) && // tslint:disable-line
          this._tMode === 'REST'
        ) {
          continue
        }
