export default function (gantt) {
  function isEnabled() {
    return (
      gantt.config.auto_types && // if enabled
      gantt.getTaskType(gantt.config.types.project) == gantt.config.types.project
    ) // and supported
  }
  ...
  gantt.attachEvent(
    'onBeforeTaskDelete',
    callIfEnabled(function (id, task) {
  ...
  gantt.attachEvent(
    'onRowDragStart',
    callIfEnabled(function (id, target, e) {
  ...
  gantt.attachEvent(
    'onRowDragEnd',
    callIfEnabled(function (id, target) {
  ...
  gantt.attachEvent(
    'onBeforeTaskMove',
    callIfEnabled(function (sid, parent, tindex) {
  ...
  gantt.attachEvent(
    'onAfterTaskMove',
    callIfEnabled(function (id, parent, tindex) {
