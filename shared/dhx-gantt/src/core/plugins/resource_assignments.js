export default function (gantt) {
      ...
      assignments.forEach(function (res) {
        ...
        if (
          !(
            ...
            assignment.start_date.getMonth &&
            assignment.end_date &&
            assignment.end_date.getMonth &&
            typeof assignment.duration === 'number'
          )
        ) {
  ...
  function _syncOnTaskUpdate(task) {
    var storeAssignments =
      task[resourceAssignmentsProperty] ||
      resourceAssignmentsStore.find(function (a) {
