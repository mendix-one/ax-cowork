...
export default function (gantt) {
  ...
  var dateHelper = {
    ...
    date_part: function (date) {
      ...
      if (
        date.getHours() && //shift to yesterday on dst
    ...
    _add_days: function (modifiedDate, inc, originalDate) {
      ...
      var getDateCondition =
        modifiedDate.getDate() <= originalDate.getDate() ||
        modifiedDate.getMonth() < originalDate.getMonth() ||
        modifiedDate.getFullYear() < originalDate.getFullYear()
