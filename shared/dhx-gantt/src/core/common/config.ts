...
type SectionType = 'textarea' | 'time' | 'duration' | 'select' | 'typeselect' | 'parent' | 'template' | 'checkbox' | 'radio' | 'resources' | 'constraint'

type LightboxSection = Array<
  ILightboxSection | ILightboxTimeAndDurationSection | ILightboxInputControl | ILightboxSelectControl | ILightboxParentControl | ILightboxTypeselectControl
>

type LayoutView = 'grid' | 'timeline' | 'resizer' | 'scrollbar' | 'resourceGrid' | 'resourceTimeline'
