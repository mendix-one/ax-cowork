...
export default function (gantt) {
  ...
  function isScrollState() {
    ...
    var isResize =
      !!document.querySelector('.gantt_drag_marker.gantt_grid_resize_area') || !!document.querySelector('.gantt_drag_marker.gantt_row_grid_resize_area')
