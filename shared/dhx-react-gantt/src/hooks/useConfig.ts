...
import { applyFullConfig, applyPartialConfig, syncLayoutProps } from '../utils/configHelpers'
import { updateLayoutCells } from '../utils/layoutSync'
import buildLayoutDescriptor from '../utils/ganttLayoutDescriptor'

export function useConfig(ganttRef, prevConfigRef, config, debounceRender, debounceInit) {
