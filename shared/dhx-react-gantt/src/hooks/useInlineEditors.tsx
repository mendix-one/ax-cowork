...
export function useInlineEditors(ganttRef: any | null, openEditor: any, closeEditor: any, inlineEditors?: { [key: string]: any }) {
  useEffect(() => {
    if (!ganttRef.current) return
    const gantt = ganttRef.current

    if (inlineEditors) {
      Object.entries(inlineEditors).forEach(([key, _EditorComponent]) => {
