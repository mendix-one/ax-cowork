...
import { GanttStatic, CalendarConfig } from '@dhx/gantt';
import { isEqual, deepCopy } from 'lodash-es';
...
function buildCustomWeeksConfig(
	customWeeks: Record<string, CustomWeek> | undefined,
	globalHours: string[]
) {
...
export function useCalendars(
	ganttRef: React.MutableRefObject<GanttStatic | null>,
