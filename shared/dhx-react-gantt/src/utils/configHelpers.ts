...
export function applyConfigProperties(gantt: GanttStatic, newConfig: any, oldConfig: any, partial: boolean) {
...
export function applyFullConfig(gantt: GanttStatic, newConfig: any, prevConfigRef: { current: any }) {
