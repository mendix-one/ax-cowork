...
export const MpsCapacityChart = observer(() => {
  ...
  return (
    <div className="ax-mps-analysis_section">
      <div className="ax-mps-analysis_section_header">
        ...
        <div className="ax-mps-analysis_section_header_hint">Red dots mark days where demand exceeded capacity.</div>
      </div>
      <div className="ax-mps-analysis_section_body" style={{ height: 240 }}>
        {group ? (
