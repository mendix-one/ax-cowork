...
export const MpsOrderSummary = observer(() => {
  ...
  return (
    <div className="ax-mps-order_summary">
      <div className="ax-mps-order_summary_card">
        <div className="ax-mps-order_summary_card_title">
