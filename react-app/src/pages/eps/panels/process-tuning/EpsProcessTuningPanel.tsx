...
import type { TuneSuggestion } from '../../stores/process-tuning.store'
...
export const EpsProcessTuningPanel = observer((props: MainPanelControls) => {
  const { styles } = useStyles()
  const store = useEpsContext().processTuning
  return (
