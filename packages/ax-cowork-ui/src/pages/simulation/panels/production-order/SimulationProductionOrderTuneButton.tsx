...
import type { ColumnSticky, ColumnTune } from './production-order.store'
...
const ColumnTuneRow = observer(({ tune, index, total }: { tune: ColumnTune; index: number; total: number }) => {
  ...
  return (
    <div className="ax-po_tune_row">
      <div className="ax-po_tune_row_move">
      ...
      />
      <span className="ax-po_tune_row_label" title={tune.label}>{tune.label}</span>
...
export const SimulationProductionOrderTuneButton = () => (
