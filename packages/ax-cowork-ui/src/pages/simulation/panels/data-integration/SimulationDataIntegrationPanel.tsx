...
import type { DataSource, SourceStatus } from './data-integration.store'
...
export const SimulationDataIntegrationPanel = observer((props: MainPanelControls) => {
  const { styles } = useStyles()
  const store = useSimulationContext().dataIntegration
  ...
  return (
    <AxDisplayPanel type="main" icon="mdiTransitConnectionVariant" title="Data Integration" {...props}>
