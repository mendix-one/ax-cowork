...
export const SimulationComparePanel = observer((props: SubPanelControls) => {
  ...
  const planOptions = sim.simulationPlans.map((p) => ({ value: p.id, label: p.name }))
    ...
    <AxDisplayPanel type="sub" icon="mdiCompareHorizontal" title="Compare plans" {...props}>
      <div className="ax-compare_root">
        ...
        <Space style={{ padding: '0 12px 12px' }}>
          ...
          <Button type="primary" size="small" onClick={() => sim.setActiveSimulationPlan(compare.rightPlanId)}>
