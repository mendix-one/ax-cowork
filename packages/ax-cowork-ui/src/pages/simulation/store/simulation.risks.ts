...
export const shopFloorRisk = (sim: SimulationStore): RiskBadge | null => {
...
export const productionOrderRisk = (sim: SimulationStore): RiskBadge | null => {
...
export const processTuningRisk = (sim: SimulationStore): RiskBadge | null => {
...
export const capacityTuningRisk = (sim: SimulationStore): RiskBadge | null => {
