...
import { GanttStore } from '../panels/simulation/gantt.store'
import { AnalysisStore } from '../panels/analysis/analysis.store'
import { ProductionOrderStore } from '../panels/orders/production-order.store'
import { ProductionProcessStore } from '../panels/processes/production-process.store'
import { ShopFloorStore } from '../panels/capacity/shop-floor.store'
...
import { DataIntegrationStore } from '../panels/integration/data-integration.store'
...
export class MpsStore {
  ...
  confirmPreflight() {
    if (this.preflightTarget === 'simulation') this.gantt.save()
    else if (this.preflightTarget === 'orders') this.productionOrder.save()
    this.preflightTarget = null
  }
}
