...
export const MpsSimulationQuickAnalysisViolations = observer(() => {
  ...
  return (
    <div className="ax-mps-simulation_analysis_card ax-mps-simulation_analysis_card__list">
      <div className="ax-mps-simulation_analysis_card_header">
        <div className="ax-mps-simulation_analysis_card_header_title">Violations / High-Load</div>
      ...
      <div className="ax-mps-simulation_analysis_card_list_box">
        {rows.length === 0 ? (
          ...
          <Space vertical size={6} style={{ width: '100%' }}>
            {rows.map(({ kind, group, ratio }) => (
              <div key={group.name} className={`ax-mps-simulation_analysis_row ${kind}`}>
                <Space size={6}>
