...
export const MpsComparePanel = observer((props: SubPanelControls) => {
  ...
  return (
    <AxDisplayPanel type="sub" icon="mdiCompareHorizontal" title="Compare plans" {...props}>
      <div className="ax-mps-compare_root">
        {/* Plan selectors */}
        <div className="ax-mps-compare_selectors">
          <div className="ax-mps-compare_selector">
            <Typography.Text type="secondary" className="text-sm">
              Plan A · baseline
            </Typography.Text>
            <Select size="small" value={compare.leftPlanId} onChange={(v) => compare.setLeftPlan(v)} options={planOptions} style={{ width: '100%' }} />
          </div>
          <AxMuiIcon icon="mdiSwapHorizontalVariant" size={18} className="ax-mps-compare_selector_arrow" />
          <div className="ax-mps-compare_selector">
            <Typography.Text type="secondary" className="text-sm">
              Plan B · candidate
            </Typography.Text>
        ...
        {/* Diff KPI strip */}
        <div className="ax-mps-compare_kpis">
          <div className="ax-mps-compare_kpi">
            <div className="ax-mps-compare_kpi_label">Committed</div>
            <div className="ax-mps-compare_kpi_value">{right.committed.toLocaleString()}</div>
          ...
          <div className="ax-mps-compare_kpi">
            <div className="ax-mps-compare_kpi_label">Wafers out</div>
            <div className="ax-mps-compare_kpi_value">{right.out.toLocaleString()}</div>
          ...
          <div className="ax-mps-compare_kpi">
            <div className="ax-mps-compare_kpi_label">At-risk POs</div>
            <div className="ax-mps-compare_kpi_value">{right.atRiskPoCount}</div>
          ...
          <div className="ax-mps-compare_kpi">
            <div className="ax-mps-compare_kpi_label">Plan end</div>
            <div className="ax-mps-compare_kpi_value">{right.endDate.slice(5)}</div>
          ...
          <div className="ax-mps-compare_kpi">
            <div className="ax-mps-compare_kpi_label">Bottleneck</div>
            <div className="ax-mps-compare_kpi_value ax-mps-compare_kpi_value__small">{right.bottleneckGroup}</div>
