...
import { MpsShopFloorCapacityChart } from './MpsShopFloorCapacityChart'
import { MpsShopFloorOee } from './MpsShopFloorOee'
import { MpsShopFloorConstraints } from './MpsShopFloorConstraints'
...
const ShopFloorDetail = observer(({ group }: { group: ToolGroup }) => {
  ...
  return (
    <>
      ...
      <MpsShopFloorCapacityChart />

      {/* 4. OEE breakdown */}
      <MpsShopFloorOee />

      {/* 5. Constraints */}
      <MpsShopFloorConstraints />
...
// ----- Panel root ---------------------------------------------------------------------------------
export const MpsShopFloorPanel = observer((props: MainPanelControls) => {
  const store = useMpsContext().shopFloor
  return (
    <AxDisplayPanel type="main" icon="mdiFactory" title="Capacity" tools={<ShopFloorToolbar />} {...props}>
