...
// (renderers, accessors, widths) live in MpsProductionOrderTable; this store only carries
...
export class ProductionOrderStore {
  ...
  // Mirrors GanttStore.unsavedEditsCount so MpsScheduleActions can drive the
