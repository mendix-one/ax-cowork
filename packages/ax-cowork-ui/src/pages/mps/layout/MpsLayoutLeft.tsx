...
const GROUPS: Group[] = [
  {
    caption: 'Plan',
    items: [
      { id: 'simulation', icon: 'mdiChartGantt', title: 'Simulation' },
      { id: 'analysis', icon: 'mdiChartBar', title: 'Analysis' },
      { id: 'orders', icon: 'mdiClipboardListOutline', title: 'Orders' },
      { id: 'processes', icon: 'mdiSitemapOutline', title: 'Processes' },
      { id: 'capacity', icon: 'mdiFactory', title: 'Capacity' },
    ],
  },
  {
    caption: 'Tuning',
  ...
  {
    caption: 'System',
    items: [{ id: 'integration', icon: 'mdiTransitConnectionVariant', title: 'Integration' }],
  },
]

export const MpsLayoutLeft = observer(() => {
