...
const COLOR_TOTAL = '#37474F' // $ax-eps-capacity — total tool-group capacity
  ...
  return (
    <div className="ax-eps-simulation_analysis_card ax-eps-simulation_analysis_card__chart">
      <div className="ax-eps-simulation_analysis_card_header">
        <div className="ax-eps-simulation_analysis_card_header_title">Tool-group capacities</div>
