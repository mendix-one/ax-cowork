  ...
  return (
    <div className="ax-eps-order_fams">
      {family.batches.map((b) => (
        <button key={b.id} type="button" className="ax-eps-order_fams_item" onClick={() => po.selectRow(`batch::${family.id}::${b.id}`)}>
          <div className="ax-eps-order_fams_item_top">
            <span className="ax-eps-order_fams_item_label">{b.name}</span>
  ...
  return (
    <div className="ax-eps-order_fams">
      {order.schedule.map((f) => {
        ...
        return (
          <button key={f.id} type="button" className="ax-eps-order_fams_item" onClick={() => po.selectRow(`family::${f.id}`)}>
            <div className="ax-eps-order_fams_item_top">
              <span className="ax-eps-order_fams_item_label">{f.label}</span>
              <Tag color="default" style={{ margin: 0 }}>
                {f.tech}
              </Tag>
...
export const EpsOrderInfoPanel = observer(() => {
    ...
    if (row.kind === 'po') {
      ...
      titleLeft = (
        <span className="ax-eps-order_info_header_title">
          <span className="ax-eps-order_info_header_title_code">{order.id}</span>
          <span className="ax-eps-order_info_header_title_sep">·</span>
          <span className="ax-eps-order_info_header_title_context">{order.customer}</span>
      ...
      titleLeft = (
        <span className="ax-eps-order_info_header_title">
          <span className="ax-eps-order_info_header_title_code">{family.label}</span>
          <span className="ax-eps-order_info_header_title_sep">·</span>
          <span className="ax-eps-order_info_header_title_context">{order.id}</span>
      ...
      titleLeft = (
        <span className="ax-eps-order_info_header_title">
          <span className="ax-eps-order_info_header_title_code">{batch.name}</span>
          <span className="ax-eps-order_info_header_title_sep">·</span>
          <span className="ax-eps-order_info_header_title_context">{family!.label}</span>
          <StateChip state={state} />
        </span>
      )
      titleActions = (
  ...
  const heightClass = row && order ? 'ax-eps-order_info__detail' : 'ax-eps-order_info__summary'
          ...
          (() => {
            ...
            return (
              <div className="ax-eps-order_info_card">
                ...
                {/* ---- Notes ----------------------------------------------------------------- */}
                <div className="ax-eps-order_info_section">
                  <div className="ax-eps-order_info_section_title">Notes ({po.getNotes(noteKeyForOrder(order.id)).length})</div>
          ...
          (() => {
            ...
            return (
              <div className="ax-eps-order_info_card">
                ...
                {/* ---- Notes ----------------------------------------------------------------- */}
                <div className="ax-eps-order_info_section">
                  <div className="ax-eps-order_info_section_title">Notes ({po.getNotes(noteKey).length})</div>
