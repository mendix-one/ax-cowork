function Ft(p, S) {
  for (var x = 0; x < S.length; x++) {
    ...
    if (typeof h != 'string' && !Array.isArray(h)) {
      for (const m in h)
        if (m !== 'default' && !(m in p)) {
          const T = Object.getOwnPropertyDescriptor(h, m)
          T && Object.defineProperty(p, m, T.get ? T : { enumerable: !0, get: () => h[m] })
        }
    }
  }
...
;(function (p) {
  ;(function () {
    ...
    function h(t, n, e) {
      return (
        (h = Function.prototype.bind && Function.prototype.bind.toString().indexOf('native code') != -1 ? S : x),
    ...
    function F(t, n, e, i) {
      if (((n = t.c.createElement(n)), e))
        for (var o in e) e.hasOwnProperty(o) && (o == 'style' ? (n.style.cssText = e[o]) : n.setAttribute(o, e[o]))
    ...
    function lt(t) {
      ...
      return (
        t &&
          ((i = t.match(/(normal|oblique|italic)/i)) && i[1] && (e = i[1].substr(0, 1).toLowerCase()),
          (i = t.match(/([1-9]00|normal|bold)/i)) &&
            i[1] &&
            (/bold/i.test(i[1]) ? (n = 7) : /[1-9]00/.test(i[1]) && (n = parseInt(i[1].substr(0, 1), 10)))),
        e + n
      )
    }
    function pt(t, n) {
    ...
    function j(t, n, e) {
      t.j && t.h[n] && (e ? t.h[n](e.c, g(e)) : t.h[n]())
    }
    function vt() {
      this.c = {}
    }
    ...
    function V(t, n, e, i, o, s, r) {
      ;((this.v = t),
        ...
        (t = new v(this.a.c + ',serif', g(this.a))),
        (t = C(t)),
        (this.g.a.style.cssText = t),
        (t = new v(this.a.c + ',sans-serif', g(this.a))),
        (t = C(t)),
        (this.h.a.style.cssText = t),
        (t = new v('serif', g(this.a))),
        (t = C(t)),
        (this.j.a.style.cssText = t),
        (t = new v('sans-serif', g(this.a))),
        (t = C(t)),
    ...
    V.prototype.start = function () {
      ;((this.f.serif = this.j.a.offsetWidth), (this.f['sans-serif'] = this.m.a.offsetWidth), (this.A = m()), Q(this))
    }
    function J(t, n, e) {
      for (var i in O) if (O.hasOwnProperty(i) && n === t.f[O[i]] && e === t.f[O[i]]) return !0
      return !1
    }
    function Q(t) {
      var n = t.g.a.offsetWidth,
        e = t.h.a.offsetWidth,
        i
      ;((i = n === t.f.serif && e === t.f['sans-serif']) || (i = X() && J(t, n, e)),
        i
          ? m() - t.A >= t.w
    ...
    ;((k.prototype.g = function (t) {
      ...
      ;(n.g &&
        y(
          n.f,
          [n.a.c('wf', t.c, g(t).toString(), 'active')],
          [n.a.c('wf', t.c, g(t).toString(), 'loading'), n.a.c('wf', t.c, g(t).toString(), 'inactive')]
        ),
        j(n, 'fontactive', t),
        (this.m = !0),
        Y(this))
      ...
      (k.prototype.h = function (t) {
        var n = this.a
        if (n.g) {
          var e = D(n.f, n.a.c('wf', t.c, g(t).toString(), 'active')),
            i = [],
            o = [n.a.c('wf', t.c, g(t).toString(), 'loading')]
          ;(e || i.push(n.a.c('wf', t.c, g(t).toString(), 'inactive')), y(n.f, i, o))
        }
        ;(j(n, 'fontinactive', t), Y(this))
      }))
    function Y(t) {
      --t.f == 0 &&
        t.j &&
        (t.m
          ? ((t = t.a),
            t.g && y(t.f, [t.a.c('wf', 'active')], [t.a.c('wf', 'loading'), t.a.c('wf', 'inactive')]),
            j(t, 'active'))
          : R(t.a))
    }
    function Z(t) {
          ...
          if (e.length === 0 && s) R(n.a)
            ...
            for (f = 0; f < e.length; f++) {
              var u = e[f],
                ...
                _ = u
              if (
                (d.g && y(d.f, [d.a.c('wf', _.c, g(_).toString(), 'loading')]),
                j(d, 'fontloading', _),
                (d = null),
                N === null)
              )
                if (window.FontFace) {
                  var _ = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
                    Nt =
                      /OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent) &&
                      /Apple/.exec(window.navigator.vendor)
                  N = _ ? 42 < parseInt(_[1], 10) : !Nt
                } else N = !1
              ;(N
                ? (d = new U(h(n.g, n), h(n.h, n), n.c, u, n.s, l))
                : (d = new V(h(n.g, n), h(n.h, n), n.c, u, n.s, r, l)),
                c.push(d))
            }
    ...
    tt.prototype.load = function (t) {
          ...
          if (r)
            for (var c = 0; c < r.length; c++) {
              ...
              r[c].fontStyle != null && r[c].fontWeight != null
                ? ((f = r[c].fontStyle + r[c].fontWeight), a.push(new v(u, f)))
                : a.push(new v(u))
            }
          t(a)
        } else
      ...
      if (i) {
        var s = e.c.o
        P(this.c, (e.a.api || 'https://fast.fonts.net/jsapi') + '/' + i + '.js' + (o ? '?v=' + o : ''), function (r) {
          r
            ? t([])
    ...
    nt.prototype.load = function (t) {
      var n,
        ...
        r = new $()
      for (n = 0, e = i.length; n < e; n++) L(this.c, i[n], M(r))
      var a = []
      for (n = 0, e = o.length; n < e; n++)
        if (((i = o[n].split(':')), i[1]))
          for (var f = i[1].split(','), c = 0; c < f.length; c += 1) a.push(new v(i[0], f[c]))
        else a.push(new v(i[0]))
      q(r, function () {
        t(a, s)
      })
    }
    ...
    var it = { latin: 'BESbswy', 'latin-ext': 'çöüğş', cyrillic: 'йяЖ', greek: 'αβΣ', khmer: 'កខគ', Hanuman: 'កខគ' },
      Et = {
        thin: '1',
        extralight: '2',
        'extra-light': '2',
    ...
    function Ct(t) {
      for (var n = t.f.length, e = 0; e < n; e++) {
        ...
        if (2 <= i.length) {
            ...
            for (var a = a.split(','), f = a.length, c = 0; c < f; c++) {
              ...
              if (((u = a[c]), u.match(/^[\w-]+$/))) {
                ...
                if (l == null) u = ''
                  ...
                  if (((u = l[2]), (u = u == null || u == '' ? 'n' : bt[u]), (l = l[1]), l == null || l == '')) l = '4'
                  else
                    var d = Et[l],
                      l = d || (isNaN(l) ? '4' : l.substr(0, 1))
                  u = [u, l].join('')
                }
              } else u = ''
              u && r.push(u)
          ...
          ;(0 < r.length && (s = r),
            i.length == 3 &&
              ((i = i[2]), (r = []), (i = i ? i.split(',') : r), 0 < i.length && (i = it[i[0]]) && (t.c[o] = i)))
        }
        for (t.c[o] || ((i = it[o]) && (t.c[o] = i)), i = 0; i < s.length; i += 1) t.a.push(new v(o, s[i]))
      }
    }
    function et(t, n) {
      ;((this.c = t), (this.a = n))
    ...
    et.prototype.load = function (t) {
      var n = new $(),
        e = this.c,
        i = new jt(this.a.api, this.a.text),
        o = this.a.families
      xt(i, o)
      var s = new St(o)
      ;(Ct(s),
            ...
            function (i) {
              if (i) t([])
                ...
                for (var o = [], s = 0; s < i.length; s += 2)
                  for (var r = i[s], a = i[s + 1], f = 0; f < a.length; f++) o.push(new v(r, a[f]))
                try {
        ...
        ? (e.__webfontfontdeckmodule__ || (e.__webfontfontdeckmodule__ = {}),
          (e.__webfontfontdeckmodule__[n] = function (o, s) {
            for (var r = 0, a = s.fonts.length; r < a; ++r) {
              var f = s.fonts[r]
              i.a.push(new v(f.name, lt('font-weight:' + f.weight + ';font-style:' + f.style)))
            }
            t(i.a)
          }),
          P(this.c, (this.f.api || 'https://f.fontdeck.com/s/css/js/') + ut(this.c) + '/' + n + '.js', function (o) {
            o && t([])
          }))
        : t([])
    }
    ...
    p.exports ? (p.exports = rt) : ((window.WebFont = rt), window.WebFontConfig && w.load(window.WebFontConfig))
  })()
})(at)
var ft = at.exports
const Wt = Pt(ft),
  It = Ft({ __proto__: null, default: Wt }, [ft])
export { It as w }
