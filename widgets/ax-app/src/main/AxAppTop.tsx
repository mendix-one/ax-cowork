...
// (kept in sync with widget props by AxAppSync) — this view touches no widget props directly.
export const AxAppTop = observer((): ReactElement => {
  const store = useAxAppStore()
  const labels = store.labels
  const menus = store.headerMenus
  return (
