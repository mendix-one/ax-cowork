...
// and active state both come from the store (kept in sync with widget props by AxAppSync), so
// the rail and the content stack in AxAppMain stay in sync without touching widget props.
    ...
    <Layout.Sider width="2.65rem" className="ax-sim_rail ax-sim_rail_left" style={{ padding: '0.15rem' }}>
      <Flex vertical align="center" justify="space-between" className="ax-sim_rail_inner">
        <Flex vertical align="center" justify="start">
          <Space vertical>
            <AxMenuBtn title={labels.simulation} placement="right" active={store.activeLeft === 'simulation'} onClick={() => store.selectLeft('simulation')}>
            ...
            <AxMenuBtn title={labels.projects} placement="right" active={store.activeLeft === 'projects'} onClick={() => store.selectLeft('projects')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <title>format-list-bulleted-square</title>
                <path d="M3,4H7V8H3V4M9,5V7H21V5H9M3,10H7V14H3V10M9,11V13H21V11H9M3,16H7V20H3V16M9,17V19H21V17H9" />
              </svg>
            </AxMenuBtn>
            <AxMenuBtn title={labels.analysis} placement="right" active={store.activeLeft === 'analysis'} onClick={() => store.selectLeft('analysis')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <title>chart-bar</title>
                <path d="M22,21H2V3H4V19H6V10H10V19H12V6H16V19H18V14H22V21Z" />
              </svg>
            </AxMenuBtn>
            <AxMenuBtn title={labels.pmData} placement="right" active={store.activeLeft === 'pmData'} onClick={() => store.selectLeft('pmData')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <AxMenuBtn
              ...
              onClick={() => store.selectLeft('tuningLogic')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <Space vertical>
            <AxMenuBtn title={labels.setting} placement="right" active={store.activeLeft === 'setting'} onClick={() => store.selectLeft('setting')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
