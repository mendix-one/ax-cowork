...
import { AxAppMain } from './main/AxAppMain'
...
// isLayout ensures the bus exists — this widget is the host layout. AxAppMain and the rail
// children below it work purely off store state.
export const AxAppSync = observer((props: AxAppLayoutContainerProps): ReactElement => {
