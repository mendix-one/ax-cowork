    ...
    return (
        <AntApp>
            ...
            <Typography.Paragraph type="secondary">
                Mendix props are mocked. Try <code>admin</code> / <code>password</code> for the success path; anything
                else surfaces the inline error.
                    ...
                    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
                        ...
                        <Card type="inner" title="Current state" size="small">
                            <pre style={{ margin: 0, fontSize: 12 }}>
                                {JSON.stringify({ account, password, errorMessage, isBusy }, null, 2)}
                            </pre>
                        </Card>
                    </Space>
                </Card>
