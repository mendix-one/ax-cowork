...
export function AxLoginSimPage() {
    ...
    return (_jsxs(AntApp, { children: [_jsx(Typography.Title, { level: 3, children: "AxLogin" }), _jsxs(Typography.Paragraph, { type: "secondary", children: ["Mendix props are mocked. Try ", _jsx("code", { children: "admin" }), " / ", _jsx("code", { children: "password" }), " for the success path; anything else surfaces the inline error."] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 320px', gap: 24, alignItems: 'start' }, children: [_jsx(Card, { title: "Rendered widget", style: { display: 'flex', justifyContent: 'center' }, children: _jsx(AxLogin, { ...props }) }), _jsx(Card, { title: "Sim controls", size: "small", children: _jsxs(Space, { direction: "vertical", size: "middle", style: { width: '100%' }, children: [_jsxs(Space, { children: [_jsx(Switch, { checked: showLogo, onChange: setShowLogo }), " Show logo"] }), _jsxs(Space, { children: [_jsx(Switch, { checked: enableSignUp, onChange: setEnableSignUp }), " Show sign-up link"] }), _jsx(Button, { size: "small", onClick: () => {
                                        setAccount('');
                                        setPassword('');
                                        setErrorMessage(null);
                                        setIsBusy(false);
                                    }, children: "Reset" }), _jsx(Card, { type: "inner", title: "Current state", size: "small", children: _jsx("pre", { style: { margin: 0, fontSize: 12 }, children: JSON.stringify({ account, password, errorMessage, isBusy }, null, 2) }) })] }) })] })] }));
}
